      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <a href="https://www.instagram.com/delcoink" target="_blank" rel="noopener noreferrer" class="text-gray-700 hover:text-forest transition-colors" aria-label="Instagram">
